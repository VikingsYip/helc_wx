...
Page({
  ...
  getList(isShow = true){
    ...
    GET("apply/u/n/page", { current: pageNo, size: 30, name: this.data.searchValue }, isShow, (flag, data, des) => {
      if (flag) {
  ...
  clickToDetail(e){
    var id = e.currentTarget.dataset.id;
    wx.navigateTo({
      url: '/pages/work/orderDetail/index?id='+id + "&flag=1",
    })
  },
  searchConfirm(){
    this.setData({
